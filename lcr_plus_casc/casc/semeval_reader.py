    ...
    with open(f_out, 'w', encoding='utf-8') as file:
        ...
        for sentence in root.iter('sentence'):
            ...
            for opinion in sentence.iter('Opinion'):
                ...
                line = f"{str(cntr).ljust(4, ' ')}\t{category}\t{polarity}\t{sep_sentence}\n"
                act_cnt += 1
                file.write(line)
...
if __name__ ==  "__main__":
    ...
    # semeval_to_csv(r'datasets\restaurant\EN_REST_SB1_TEST.xml.gold' , 'test_single16.txt', multi=False)
    semeval_to_csv(r'datasets\restaurant\EN_REST_SB1_TEST.xml.gold' , 'test_multi16.txt', multi=True)

    # semeval_to_csv('ABSA-15_Restaurants_Train_Final.xml' , 'val_single15.txt', multi=False)
    # semeval_to_csv('ABSA-15_Restaurants_Train_Final.xml' , 'val_multi15.txt', multi=True)

    # semeval_to_csv('ABSA15_Restaurants_Test.xml' , 'test_single15.txt', multi=False)
